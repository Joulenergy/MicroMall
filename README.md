...
#### Grafana
Grafana dashboards have been mounted using the ./grafana/dashboards:/etc/grafana/provisioning/dashboards bind mount. This was done by exporting the dashboards I have made in json files for external sharing into my local folder. By configuring the dashboard.yml file, I added a uid for each datasource, and replaced all the uids in the exported files with the uids I configured since I was getting an error that it cannot find my datasources after mounting the dashboards.